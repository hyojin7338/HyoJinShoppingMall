...
const MasterQuestionDetail = () => {
    ...
    useEffect(() => {
        const fetchQuestionDetail = async () => {
            try {
                const response = await axios.get(`http://15.164.216.15/api/master/question/${productQuestionId}`,{
        ...
        const fetchAnswers = async () => {
            try {
                const response = await axios.get(`http://15.164.216.15/api/product/answerCreate/${productQuestionId}`,{
                    withCredentials: true,
                });
    ...
    const handleAnswerSubmit = async () => {
        ...
        try {
            await axios.post("http://15.164.216.15/api/product/answerCreate"
                , {
                productQuestionId,
